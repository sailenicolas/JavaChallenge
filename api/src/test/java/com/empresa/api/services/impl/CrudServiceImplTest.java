...
class CrudServiceImplTest {
    ...
    void getById() {
        ...
        value.setId("1");
        value.setPoint("2");
        when(cachePosCostRepository.findById(anyString())).thenReturn(value);
    ...
    @Test
    void putCache() {
        when(cachePosCostRepository.findById(anyString())).thenReturn(new PosHash());
        PosHash value = new PosHash();
        value.setId("1");
        value.setPoint("2");
